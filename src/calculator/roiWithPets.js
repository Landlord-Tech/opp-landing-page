const calculateROIWithPets = ({
    ...
    const propManageTimeWithoutOPP = Math.round((unitCount * unitPerPetRate * propManagementWagePerHour * petDealTimeInHours) +
        (unitCount * unitPerPetRate * propManagementWagePerHour * petPerRental * ESABeforeOPPRate))
    const propManageTimeWithOPP = Math.round((propManageTimeWithoutOPP * fraudulentESAtoPetConversion) -
